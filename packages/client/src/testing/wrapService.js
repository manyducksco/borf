...
/**
 * Wraps a service with a set of mock services. Returns a function that
 * can be initialized the same way as a regular service.
 */
export function wrapComponent(service, configure) {
  ...
  WrappedService.isWrapped = true;
  WrappedService.getService = getService;
