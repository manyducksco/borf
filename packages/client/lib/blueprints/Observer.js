...
export class ObserverBlueprint {
  ...
  build({ appContext, elementContext }) {
    return new ObserverView(this.observable, this.render, { appContext, elementContext });
  }
}

class ObserverView {
  constructor(observable, render, { appContext, elementContext }) {
