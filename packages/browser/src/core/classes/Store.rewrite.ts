...
import { DebugChannel } from "./DebugHub.js";
 ...
 */
class Store<I, O> extends Component<I> {
  ...
  create(config: CreateStoreConfig<I>): Connectable {
  ...
  static define<I, O>(definition: StoreDefinition<I, O>): Store<I, O> {
...
interface StoreInstanceConfig<I, O> extends ComponentInstanceConfig<I> {
  setup: StoreSetupFunction<I, O>;
}

class StoreInstance<I, O> extends ComponentInstance<I> {
